...
<head>
    ...
    <title>GAME SET SCHDULE | Games</title>
</head>
...
<body>
    ...
    <div class="row mt-3" style="background-color: #d6011d; color:white;">
        <div class="container">
            <h1 class="font-weight-bold mt-4" style="color:white;font-size:47px !important;" data-aos="fade-right" data-aos-duration="1200">Mau top-up? cek kategori dibawah ini!</h1>
        </div>
    </div>
