                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="container bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                                <table id="example" class="table align-items-center table-flush" style="overflow-x: scroll;min-width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <img height="30px" src="<?= base_url() . 'assets/profile_picture/' . $u->image; ?>">
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="<?php echo site_url('admin/publisher_detail/' . $u->id_publisher); ?>" class="btn btn-success">Detail</a>
                                                </td>


                                                <td class="text-center">

                                                    <a href="<?php echo site_url('admin/publisher_update/' . $u->id_publisher); ?>" class="btn btn-info remove">Update</a>
                                                    <a href="<?php echo site_url('admin/publisher_delete/' . $u->id_publisher); ?>" class="btn btn-danger remove">Delete</a>
                                                </td>
