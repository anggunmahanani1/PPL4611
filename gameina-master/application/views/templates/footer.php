...
<footer class="page-footer font-small pt-4 mt-5">
    <div class="container">
        ...
        <div class="container-fluid text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-md-0 mt-3">
                    ...
                    <!-- Content -->
                    <h3 class="text-uppercase footer-text">Tentang GAME SET SCHDULE</h3>
                    <p>GAME SET SCHDULE Adalah portal game pertama di indonesia, yang menyediakan fasilitas untuk para
                        developer
        ...
        <div class="footer-copyright text-center small py-3">© 2021 Copyright :
            <a href="syauqizaidan.github.io" class="text-white"> GAME SET SCHDULE / Kelompok 8</a>
        </div>
    </div>
    <!-- Copyright -->
