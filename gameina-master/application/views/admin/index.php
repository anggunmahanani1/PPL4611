        ...
        <div class="main-wrapper">
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>img/hero.png">
                            <div class="hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['nama_admin'];
                                                    ?>!</h1>
                                <p class="lead">Di Halaman Admin - GAME SET SCHDULE | Web Portal Game Indonesia - <br> Pertama di
                                    Indonesia</p>
                                <div class="mt-4">
                                    <a href="<?= base_url('admin/user_data') ?>" class="btn btn-outline-white btn-lg btn-icon icon-left"><i class="far fa-user"></i> User Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2021 <div class="bullet"></div> Program & Design by <a href="syauqizaidan.github.io">GAME SET SCHDULE</a>
                </div>
