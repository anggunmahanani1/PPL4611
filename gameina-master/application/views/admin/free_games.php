                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img height="30px" src="<?= base_url() . 'assets/img/' . $u->gambar_game; ?>">
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="<?php echo site_url('admin/free_games_detail/' . $u->id_game); ?>" class="btn btn-success">Detail</a>
                                                </td>
                                                <td class="text-center">

                                                    <a href="<?php echo site_url('admin/free_games_update/' . $u->id_game); ?>" class="btn btn-info">Update</a>

                                                    <a href="<?php echo site_url('admin/free_games_delete/' . $u->id_game); ?>" class="btn btn-danger remove">Delete</a>
