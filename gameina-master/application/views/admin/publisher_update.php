                    ...
                    <div class="row container">
                        <div class="col-md-7 bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            ...
                            <?php foreach ($publisher as $u) { ?>
                                ...
                                <form action="<?= base_url('admin/publisher_edit') ?>" enctype="multipart/form-data" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type=" text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required name="nama" value="<?= $u->nama_publisher ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1" class="font-weight-bold" style="font-size: 20px;">Email</label>
                                        <input type="email" class="form-control" readonly name="email" value="<?= $u->email_publisher ?>" id="exampleInputPassword1">
                                    </div>
