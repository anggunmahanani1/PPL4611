            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>GAME SET SCHDULE - User Data </h1>
                    </div>
                    <div class="section-header">
                                        ...
                                        ?>
                                            <tr class="text-center">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="<?php echo site_url('admin/user_detail/' . $u->id); ?>" class="btn btn-success">Detail</a>
                                                </td>

                                                <td class="text-center">

                                                    <a href="<?php echo site_url('admin/user_update/' . $u->id); ?>" class="btn btn-info">Update</a>

                                                    <a href="<?php echo site_url('admin/user_delete/' . $u->id); ?>" class="btn btn-danger remove">Delete</a>
